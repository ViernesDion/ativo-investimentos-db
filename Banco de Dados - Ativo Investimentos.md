---
status: concluído
tags: [banco-de-dados, postgresql, faculdade, sql]
data_apresentacao: 2025-11
---
---
status: concluído
tags: [banco-de-dados, postgresql, faculdade, sql]
...
# 🏦 Banco de Dados: Ativo Investimentos

## 📌 Visão Geral do Projeto
Desenvolvimento de um banco de dados relacional para uma consultoria de investimentos. Este projeto foi desenvolvido em grupo para a faculdade e apresentado no congresso universitário.

* **Objetivo:** Estruturar o armazenamento de dados de clientes, perfis de investimento, carteiras e projeções de rentabilidade.
* **Tecnologias:** [[PostgreSQL]], [[Modelagem de Dados]].

## 📐 Modelagem e Design
A estruturação visual e o rascunho das entidades foram trabalhados colaborativamente.
* **Link do Figma:**(https://www.figma.com/make/Tl4tomezoq9i3EJIM6N95j/Ativo-Investimentos?p=f&t=fInwyzSPLpHpX5bi-0&fullscreen=1)

## 💻 Scripts SQL Completos (PostgreSQL)
